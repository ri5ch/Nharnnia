...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/styleShowPrenda.css') }}">
</head>
<body class="cuerpo">
    ...
    <div class="d-flex justify-content-center align-items-center vh-80">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 prenda-img-container">
                    <img src="{{ $prenda->imagen }}" alt="{{ $prenda->nombre }}" class="prenda-img img-fluid">
                </div>
                <div class="col-md-6 prenda-details">
                    <h1 class="nombre-prenda">{{ $prenda->nombre }}</h1>
                    <p class="atributo-prenda"><strong>Estilo:</strong> {{ $prenda->estilo }}</p>
                    <p class="atributo-prenda"><strong>Color:</strong> {{ $prenda->color1 }}, {{ $prenda->color2 }}</p>
                    <p class="atributo-prenda"><strong>Tipo:</strong> {{ $prenda->tipo }}</p>
                    <p class="atributo-prenda"><strong>Precio:</strong> {{ $prenda->precio }} €</p>
                    <p class="atributo-prenda"><strong>Género:</strong> {{ $prenda->genero }}</p>
                    <form action="{{ route('carrito.agregar', $prenda->id) }}" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-dark btn-add-to-cart boton-carrito">Añadir al carrito</button>
                    </form>
                    <a href="{{ route('prendas.index') }}" class="btn btn-dark boton-volver">Volver a la lista de prendas</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                        <!-- Links -->
                        <h6 class="text-uppercase fw-bold mb-4">Prendas</h6>
                        <p><a href="{{ route('prendas.index') }}" class="text-reset">Todas</a></p>
                        <p><a href="{{ route('prendas.indexHombre') }}" class="text-reset">Hombre</a></p>
                        <p><a href="{{ route('prendas.indexMujer') }}" class="text-reset">Mujer</a></p>
                    </div>
                    <!-- Grid column -->
                    ...
                    <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <p><a href="{{ route('armario.mostrar') }}" class="text-reset">Armario</a></p>
                        <p><a href="{{ route('armario.generar_outfit') }}" class="text-reset">Generar Outfit</a></p>
                    </div>
                    <!-- Grid column -->
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p><i class="fas fa-envelope me-3"></i> nharnnia@gmail.com</p>
