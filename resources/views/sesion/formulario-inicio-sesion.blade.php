...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/styleSesion.css') }}">
        ...
        <div class="contenedor-login">
            <div class="container">
                ...
                <div class="contenedor-registrarse">
                    <p style="text-align:center; margin-top: 20px;">¿No tienes una cuenta?</p>
                    <a href="{{route ('sesion.formulario-registro')}}">
